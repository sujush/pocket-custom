...
export default function DocumentsMaking() {
    ...
    const generateExcel = async () => {
        ...
        const dataMerges = [
            ...
            { range: 'A21:B21', value: formData.loadingPort },      // Port of Loading 추가
            { range: 'C21:E21', value: formData.dischargePort },    // Final Destination 추가
            { range: 'A23:B23', value: formData.carrier },          // Carrier 추가
            { range: 'C23:E23', value: formData.vesselAndVoyage }   // Sailing on/or about 추가
        ];
