...
export default function CommonInputForm({
  ...
  return (
    <>
      <h2 className="text-2xl font-bold mb-6">공통 입력 사항</h2>
      ...
      <div className="flex items-center space-x-4 mb-6">
        ...
        <p className="text-sm text-gray-600">수출자와 수입자의 영문명칭과 주소를 입력해!</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <Select name="transportMethod" onValueChange={(value) => handleSelectChange('transportMethod', value)}>
            <SelectTrigger>
