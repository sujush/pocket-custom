            ...
            <article>
              ...
              <div className="text-gray-600 space-y-2">
                ...
                <ol className="list-decimal ml-5 space-y-1">
                  <li>&ldquo;서비스&rdquo;란 회사가 제공하는 모든 서비스를 의미합니다.</li>
                  <li>&ldquo;회원&rdquo;이란 회사와 서비스 이용계약을 체결하고 회사가 제공하는 서비스를 이용하는 개인 또는 법인을 말합니다.</li>
                  <li>&ldquo;아이디(ID)&rdquo;란 회원의 식별과 회원의 서비스 이용을 위하여 회원이 선정하고 회사가 승인하는 문자와 숫자의 조합을 말합니다.</li>
                  <li>&ldquo;비밀번호&rdquo;란 회원이 부여 받은 아이디와 일치된 회원임을 확인하고 회원의 개인정보를 보호하기 위해 회원 자신이 정한 문자와 숫자의 조합을 말합니다.</li>
                </ol>
              </div>
            </article>
          </div>
